<template>
	<div style="padding: 20px">
		...
		<el-row>
			<el-col :span="6">
				<el-button type="primary" size="default" @click="addhHandle" icon="Plus">心理信息添加</el-button>
		...
		<el-table :data="tableData" ref="accountRef" @select="handleTableChange">
			...
			<el-table-column label="性别" align="center" prop="sex" :show-overflow-tooltip="true">
				<template #default="scope">
					{{ sexFormate(scope.row.sex) }}
				</template>
			</el-table-column>
			<el-table-column label="年龄" align="center" prop="age" :show-overflow-tooltip="true" />
			<el-table-column label="班级" align="center" prop="class_name" width="120" />
			<el-table-column label="电话" align="center" prop="phone" width="120" />
			<el-table-column label="情绪" align="center" prop="emotionl" width="120" />
			<el-table-column label="评分" align="center" prop="mind_score" width="120" />
			<el-table-column label="心理问题" align="center" prop="mind_issue" width="120" />
			<el-table-column label="心理建议" align="center" prop="mind_advice" width="120" />
			<el-table-column label="心理辅导记录" align="center" prop="tutor_log" width="120" />
			<el-table-column label="评分时间" align="center" prop="grade_time" width="120">
				<template #default="scope">
		...
		<el-dialog v-model="dialogFormVisible" :title="titleList.title[titleindex]">
			<el-form size="large" class="login-content-form" style="height: 200px; overflow: auto" :model="state.ruleForm" :rules="rules" ref="ruleFormRef">
				<el-form-item class="login-animation1" prop="name">
					<el-input text placeholder="请输入姓名" v-model="state.ruleForm.name" clearable autocomplete="off"> </el-input>
				</el-form-item>
				...
				<el-form-item class="login-animation1" prop="age">
					<el-input type="text" placeholder="请输入年龄" v-model="state.ruleForm.age" clearable autocomplete="off"> </el-input>
				</el-form-item>
				<el-form-item class="login-animation1" prop="class_name">
					<el-input type="text" placeholder="班级" v-model="state.ruleForm.class_name" clearable autocomplete="off"> </el-input>
				</el-form-item>
				...
				<el-form-item class="login-animation1" prop="emotion">
					<el-input type="text" placeholder="情绪" v-model="state.ruleForm.emotion" clearable autocomplete="off"> </el-input>
				</el-form-item>
				<el-form-item class="login-animation1" prop="mind_score">
					<el-input type="text" placeholder="请输入评分" v-model="state.ruleForm.mind_score" clearable autocomplete="off"> </el-input>
				</el-form-item>
				<el-form-item class="login-animation1" prop="mind_issue">
					<el-input type="text" placeholder="请输入心理问题" v-model="state.ruleForm.mind_issue" clearable autocomplete="off"> </el-input>
				</el-form-item>
				<el-form-item class="login-animation1" prop="mind_advice">
					<el-input type="text" placeholder="请输入心理建议" v-model="state.ruleForm.mind_advice" clearable autocomplete="off"> </el-input>
				</el-form-item>
				<el-form-item class="login-animation1" prop="tutor_log">
					<el-input type="text" placeholder="请输入心理辅导记录" v-model="state.ruleForm.tutor_log" clearable autocomplete="off"> </el-input>
				</el-form-item>
			</el-form>
			<template #footer>
...
function handleEdit(index, row) {
	...
	state.ruleForm.class_name = row.class_name;
	state.ruleForm.emotion = row.emotion;
	state.ruleForm.mind_score = row.mind_score;
	state.ruleForm.mind_issue = row.mind_issue;
	state.ruleForm.mind_advice = row.mind_advice;
	state.ruleForm.tutor_log = row.tutor_log;
}
function reset() {
	state.ruleForm = {
		phone: '',
...
function getList() {
	// 此处影响路由
	// userInterface.getStuInfo().then((res) => {
